...
use Illuminate\Support\Facades\Request as FacadeRequest; // Alias the Facade
...
use Illuminate\Http\Request; // This is the injected Request
...
class LoginController extends Controller
{
    ...
    public function store(Request $request, $hash = null)
    {
        if ($hash) {
            ...
            // IMPORTANT: Use $request, not Request facade
            ...
            if (Auth::attempt($request->only(['email', 'password']), $remember_me)) {
                ...
                $loginMethodService = App::make(AuthManager::class);
    ...
    {
        $input = FacadeRequest::all(); // Use the aliased FacadeRequest here.
